...
rawbam_bcfcalls <- read.table("vcf_files/bcfpileup_baboon_merged.decap.vcf", comment.char = "", header = FALSE, check.names = FALSE)
rawbam_header <- read.table("vcf_files/bcfpileup_baboon_merged.header", comment.char = "", check.names = FALSE)
